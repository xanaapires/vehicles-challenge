...
export const defaultColors: ThemeColor = {
  primaryMain: "#4C9AFF",
  primaryLight: "#E6F0FF",
  primaryLighter: "#CCE0FF",
  primaryDark: "#1D70FF",
  primaryDarker: "#0B4D91",
  secondaryMain: "#7FDBA2",
  secondaryLight: "#CFF1DB",
  secondaryLighter: "#E6F8ED",
  secondaryVeryLighter: "#F8FBFA",
  secondaryDark: "#4CB47A",
  secondaryDarker: "#2E7D60",
  neutralWhite: "#FFFFFF",
